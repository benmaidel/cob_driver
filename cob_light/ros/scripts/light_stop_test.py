...
from cob_light.srv import StopLightModeRequest
from cob_light.srv import StopLightModeResponse
...
class ActionTestScript(object):
    def __init__(self):
        ...
        self.srv_stop_light = rospy.ServiceProxy('/light_torso/stop_mode', StopLightMode)
    ...
    def executeMode(self, event):
        ...
        res = SetLightModeResult()
        rospy.sleep(1.0)
        stop_req = StopLightModeRequest()
        stop_req.track_id = res.track_id

        self.srv_stop_light.call(stop_req)
...
if __name__ == '__main__':
  rospy.init_node('light_stop_test')
  ActionTestScript()
  rospy.spin()
